...
<div class="flex flex-col h-screen w-screen bg-white">
  ...
  <div class="flex flex-row  items-center  bottom-0 my-2 w-full">
    ...
    <div class="ml-3 mr-2 border border-gray-300 rounded-2xl ">
     <input type="text" id="nickname" name="nickname" class="border rounded-2xl border-transparent focus:outline-none text-sm h-10 flex items-center"
     >  
    </div>
    <div>
        <button
